...
class AngelaPayne extends DudeCard {
    setupCardAbilities(ability) {
        this.action({
            ...
            ifCondition: () => !this.locationCard.owner.equals(this.controller) && this.locationCard.getType() === 'deed',
            ifFailMessage: context => this.game.addMessage('{0} boots {1} but does not gain any GR because she is not at a deed {0} doesn\'t own',
                context.player, this),
